...
// Exercise: Pythagorean theorem in 3D
// Widget key: image_1
test("polyhedron-diagram - Pythagorean theorem in 3D", () => {
	const input = {
	"shape": {
...
test("polyhedron-diagram - Cross sections of 3D objects basic", () => {
	const input = {
	"shape": {
		"base": {
			"b": 4,
...
test("polyhedron-diagram - Cross sections of 3D objects basic", () => {
	...
	"labels": [
		{
			"text": "prism with a pentagonal base",
			"target": "frontFace"
		}
	],
	"diagonals": [],
...
test("polyhedron-diagram - Cross sections of 3D objects basic", () => {
	...
	"labels": [
		{
			"text": "prism with a hexagonal base",
			"target": "frontFace"
		}
	],
	"diagonals": [],
...
test("polyhedron-diagram - Cross sections of 3D objects basic", () => {
	...
	"labels": [
		{
			"text": "pyramid with a square base",
			"target": "frontFace"
		}
	],
	"diagonals": [],
...
test("polyhedron-diagram - Cross sections of 3D objects basic", () => {
	...
	"labels": [
		{
			"text": "horizontal triangular prism",
			"target": "frontFace"
		}
	],
	"diagonals": [],
...
test("polyhedron-diagram - Cross sections of 3D objects basic", () => {
	...
	"labels": [
		{
			"text": "prism with a triangular base",
			"target": "frontFace"
		}
	],
	"diagonals": [],
...
// Course: 7th grade math
// Exercise: Volume and surface area word problems
// Widget key: image_1
test("polyhedron-diagram - Volume and surface area word problems", () => {
	const input = {
	"shape": {
		"type": "rectangularPrism",
		"width": 2,
