...
// Exercise: Two-step inequalities
// Widget key: graph_choice_a
test("inequality-number-line - Two-step inequalities", () => {
	const input = {
	"max": 5,
	"min": -10,
	"width": 460,
...
// Course: 7th grade math
// Exercise: Two-step inequality word problems
// Widget key: graph_choice_a
test("inequality-number-line - Two-step inequality word problems", () => {
	const input = {
	"max": 10,
	"min": 5,
	"width": 600,
