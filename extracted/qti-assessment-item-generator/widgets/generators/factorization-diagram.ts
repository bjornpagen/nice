...
export const FactorizationDiagramPropsSchema = z.object({
    ...
    numberToFactor: z.number().int().positive().describe("The integer to be factored and displayed as a rectangular array of dots."),
    dotColor: z.string().regex(CSS_COLOR_PATTERN, "invalid css color").describe("CSS color for the dots in the array."),
}).strict().describe("Creates a rectangular array of numbered dots to visually represent the factors of a number. The widget automatically determines the number of rows and columns by finding the factors closest to the square root of the number.");
