...
export const DivisionModelDiagramPropsSchema = z.object({
...
}).strict().describe("Creates a visual model for division with remainders by arranging objects into a grid. The number of full rows represents the quotient, and the items in the last, incomplete row represent the remainder.");
