# Crons (Scheduled Functions) - Inngest Documentation
...
You can create scheduled functions that run in any timezone using the SDK's [`createFunction()`](https://www.inngest.com/docs/reference/functions/create):
