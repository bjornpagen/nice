...
*   [How it works](https://platform.openai.com/docs/guides/pdf-files?api-mode=responses#page-top)
*   [File URLs](https://platform.openai.com/docs/guides/pdf-files?api-mode=responses#file-urls)
*   [Uploading files](https://platform.openai.com/docs/guides/pdf-files?api-mode=responses#uploading-files)
*   [Base64-encoded files](https://platform.openai.com/docs/guides/pdf-files?api-mode=responses#base64-encoded-files)
*   [Usage considerations](https://platform.openai.com/docs/guides/pdf-files?api-mode=responses#usage-considerations)
*   [Next steps](https://platform.openai.com/docs/guides/pdf-files?api-mode=responses#next-steps)