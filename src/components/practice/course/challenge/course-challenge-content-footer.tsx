...
export function CourseChallengeContentFooter({
	questions,
	index,
	setIndex,
	className
}: {
	questions: Extract<CourseResource, { type: "CourseChallenge" }>["data"]["questions"]
	index: number
	...
	return (
		<div id="lesson-exercise-content-footer" className={cn("bg-white flex flex-row gap-8 items-center", className)}>
			<ExcessButtonSection questions={questions} index={index} setIndex={setIndex} setAnswered={setAnswered} />
			<QuestionOverviewSection questions={questions} index={index} setIndex={setIndex} setAnswered={setAnswered} />
			<ProgressionButtonSection
				questions={questions}
				index={index}
				setIndex={setIndex}
				answered={answered}
...
function QuestionOverviewSection({
	...
	return (
		<div
			id="lesson-exercise-content-footer-question-section"
...
function ProgressionButtonSection({
	questions,
	index,
	setIndex,
	answered,
	...
	const handleCompleteClick = () => {
		...
		// TODO: Redirect to the next exercise, lesson, etc.
	}
