...
export function Content({ testDataPromise, expectedIdentifiersPromisesPromise }: { testDataPromise: Promise<CourseChallengePageData>; expectedIdentifiersPromisesPromise: Promise<Promise<string[]>[]> }) {
