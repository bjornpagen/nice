...
export const PointPlotGraphPropsSchema = z
	...
	.strict()
	.describe("Creates a coordinate plane specifically for plotting individual points. Each point can be labeled and styled differently. Perfect for teaching coordinate pairs, quadrants, and point plotting. Unlike line or function graphs, this focuses solely on discrete point locations.")
