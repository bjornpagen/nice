...
export const KeelingCurvePropsSchema = z
	.object({
		...
		annotations: z.array(AnnotationSchema).describe("An array of declarative annotations pointing to specific years on the curve.")
	})
	.strict()
	.describe("Renders a scientifically accurate, non-interactive graph of historical CO2 levels with declarative annotations.")
...
const CO2_DATA = [
	...
	{ year: 1959, ppm: 315.98 }, { year: 1960, ppm: 316.91 }, { year: 1961, ppm: 317.64 }, { year: 1962, ppm: 318.45 },
	{ year: 1963, ppm: 318.99 }, { year: 1964, ppm: 319.62 }, { year: 1965, ppm: 320.04 }, { year: 1966, ppm: 321.37 },
	{ year: 1967, ppm: 322.18 }, { year: 1968, ppm: 323.05 }, { year: 1969, ppm: 324.62 }, { year: 1970, ppm: 325.68 },
	{ year: 1971, ppm: 326.32 }, { year: 1972, ppm: 327.46 }, { year: 1973, ppm: 329.68 }, { year: 1974, ppm: 330.19 },
	{ year: 1975, ppm: 331.13 }, { year: 1976, ppm: 332.03 }, { year: 1977, ppm: 333.84 }, { year: 1978, ppm: 335.41 },
	{ year: 1979, ppm: 336.84 }, { year: 1980, ppm: 338.76 }, { year: 1981, ppm: 340.12 }, { year: 1982, ppm: 341.48 },
	{ year: 1983, ppm: 343.15 }, { year: 1984, ppm: 344.87 }, { year: 1985, ppm: 346.35 }, { year: 1986, ppm: 347.61 },
	{ year: 1987, ppm: 349.31 }, { year: 1988, ppm: 351.69 }, { year: 1989, ppm: 353.20 }, { year: 1990, ppm: 354.45 },
	{ year: 1991, ppm: 355.70 }, { year: 1992, ppm: 356.54 }, { year: 1993, ppm: 357.21 }, { year: 1994, ppm: 358.96 },
	{ year: 1995, ppm: 360.97 }, { year: 1996, ppm: 362.74 }, { year: 1997, ppm: 363.88 }, { year: 1998, ppm: 366.84 },
	{ year: 1999, ppm: 368.54 }, { year: 2000, ppm: 369.71 }, { year: 2001, ppm: 371.32 }, { year: 2002, ppm: 373.45 },
	{ year: 2003, ppm: 375.98 }, { year: 2004, ppm: 377.70 }, { year: 2005, ppm: 379.98 }, { year: 2006, ppm: 382.09 },
	{ year: 2007, ppm: 384.02 }, { year: 2008, ppm: 385.83 }, { year: 2009, ppm: 387.64 }, { year: 2010, ppm: 390.10 },
	{ year: 2011, ppm: 391.85 }, { year: 2012, ppm: 394.06 }, { year: 2013, ppm: 396.74 }, { year: 2014, ppm: 398.81 },
	{ year: 2015, ppm: 401.01 }, { year: 2016, ppm: 404.41 }, { year: 2017, ppm: 406.76 }, { year: 2018, ppm: 408.72 },
	{ year: 2019, ppm: 411.65 }, { year: 2020, ppm: 414.21 }, { year: 2021, ppm: 416.41 }, { year: 2022, ppm: 418.53 },
	{ year: 2023, ppm: 421.08 }, { year: 2024, ppm: 424.61 }
]

const renderMultiLineText = (lines: string[], x: number, y: number, className: string, lineHeight = "1.2em"): string => {
	const tspans = lines.map((line, index) => `<tspan x="${x}" dy="${index === 0 ? "0" : lineHeight}">${line}</tspan>`).join("")
...
export const generateKeelingCurve: WidgetGenerator<typeof KeelingCurvePropsSchema> = (props) => {
	...
	svg += "<style>.axis-label { font-size: 16px; text-anchor: middle; } .annotation-label { font-size: 16px; font-weight: bold; text-anchor: start; }</style>"
