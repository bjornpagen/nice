...
export const BarChartPropsSchema = z
	.object({
		...
		yAxis: z.object({
			...
			min: z.number().optional().default(0).describe("The minimum value for the Y-axis scale."),
			max: z
				.number()
				.optional()
		...
		barColor: z.string().optional().default("#4285F4").describe('The fill color for bars in the "normal" state.')
	})
	.describe(
