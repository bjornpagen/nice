...
export const env = createEnv({
	...
	client: {
		...
		NEXT_PUBLIC_QTI_ASSESSMENT_ITEM_PLAYER_URL: z.string().url(),
		NEXT_PUBLIC_QTI_STIMULUS_PLAYER_URL: z.string().url()
	},
	...
	runtimeEnv: {
		...
		NEXT_PUBLIC_QTI_ASSESSMENT_ITEM_PLAYER_URL: process.env.NEXT_PUBLIC_QTI_ASSESSMENT_ITEM_PLAYER_URL,
		NEXT_PUBLIC_QTI_STIMULUS_PLAYER_URL: process.env.NEXT_PUBLIC_QTI_STIMULUS_PLAYER_URL,
