...
export const env = createEnv({
	...
	server: {
		...
		TIMEBACK_PRODUCTION_CLIENT_ID: z.string().min(1),
		TIMEBACK_PRODUCTION_CLIENT_SECRET: z.string().min(1),
		TIMEBACK_PRODUCTION_TOKEN_URL: z.string().min(1),
	...
	runtimeEnv: {
		...
		TIMEBACK_PRODUCTION_CLIENT_ID: process.env.TIMEBACK_PRODUCTION_CLIENT_ID,
		TIMEBACK_PRODUCTION_CLIENT_SECRET: process.env.TIMEBACK_PRODUCTION_CLIENT_SECRET,
		TIMEBACK_PRODUCTION_TOKEN_URL: process.env.TIMEBACK_PRODUCTION_TOKEN_URL,
